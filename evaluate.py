...
from data_utils import build_tokenizer, build_embedding_matrix, Tokenizer4Bert, get_example, round4
...
def test_on_dataset():
    ...
    out_lines = []
    err_lines = []
    with open(opt.test_path, "r") as reader:
        for line in reader:
            obj = json.loads(line)
            text, aspect, label = obj["text"], obj["aspect"], obj["label"]
