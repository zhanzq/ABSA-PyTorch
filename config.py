...
parser.add_argument("--do_train", action="store_true", help="to train the model")
parser.add_argument("--do_eval", action="store_true", help="to evaluate the model")
parser.add_argument("--do_test", action="store_true", help="to test the model")
